...
public static class JobCatalog
{
    public static readonly IReadOnlyList<JobDefinition> All = new List<JobDefinition>
    {
        ...
        new("export-chat-mentions", "Export chat mention contexts", "export",
            "Export chat context windows for a mention term.", () => new ExportChatMentionsJob()),
        ...
        new("tempus-wrapped", "Export Tempus Wrapped", "analysis",
            "Export a year-in-review raw dataset (chat + stats) for a user.", () => new ExportTempusWrappedJob()),
        ...
        new("wr-history-audit", "Audit WR history (map)", "analysis",
            "Report suspicious non-record WR evidence for a map (e.g. IRC/commands faster than any record).",
            () => new AuditWrHistoryFromChatJob()),
